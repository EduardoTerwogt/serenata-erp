      ...
      >
        ...
        <div className="p-4 md:p-6 border-t border-hairline flex justify-end gap-3">
          ...
          <button
            ...
            className="bg-accent hover:bg-accent-pressed text-accent-ink px-4 py-2 rounded-control text-content font-semibold transition-colors disabled:opacity-50"
          >
