...
| 3C-4 | Pendiente | 3C-3 | — | — | — | — | | Bloqueado: la medición empírica obligatoria del punto 2 exige volumen objetivo (items_cotizacion≥5500) en el entorno serverless real — hoy `serenata-erp-test` tiene 11 filas. 3A-1 ya cerró (entorno serverless real disponible y validado); sigue bloqueado únicamente por 3A-3 (sembrado de volumen), todavía sin implementar |
