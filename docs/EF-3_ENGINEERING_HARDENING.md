...
| 3A-5 | En curso | 3A-1, 3A-2, 3A-3, 3A-4 | `claude/ef3a-k6-telemetria` | [#58](https://github.com/EduardoTerwogt/serenata-erp/pull/58) (PR a), [#59](https://github.com/EduardoTerwogt/serenata-erp/pull/59) (PR b) | — | `c2959f3` (PR a), `066b99e` (PR b) | PR (a) y (b) de 3 mergeadas: los 8 escenarios de k6 completos + `_shared.js`, validación real `SMOKE=1` en verde en ambas (runs [35036940623](https://github.com/EduardoTerwogt/serenata-erp/actions/runs/35036940623), [35038537654](https://github.com/EduardoTerwogt/serenata-erp/actions/runs/35038537654)) -- PR (b) incluyó una subida real de archivos a Drive y una conexión WebSocket real al canal privado de Realtime, ambas verificadas. Ahora en curso PR (c): telemetría `pg_stat_statements` (migración + RPC + `telemetry-snapshot.mjs`/`telemetry-deltas.mjs`) | — |
