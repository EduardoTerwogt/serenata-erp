> **CERRADO — 2026-09-23.** Iniciativa completa: bloques 1 (Cotización, PR #86),
> 2 (Orden de pago, PR #88) y 3 (Hoja de llamado, PR #89) mergeados a `main`.
> El bloque 4 (Reporte de cierre) se difirió a `docs/ROADMAP.md` → "Después"
> hasta definir el módulo de Proyectos, del que depende su contenido.
> `docs/PLAN.md` se recreó vacío para la próxima iniciativa. Lo de abajo se
