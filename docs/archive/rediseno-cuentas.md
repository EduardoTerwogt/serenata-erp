...
**Estado:** **Cerrado** (sesión 21, 2026-09-26: PR #96 en `main` y producción). Fue **aprobado** por el usuario (sesión 19, 2026-09-25), después de
...
| Producción | Hecho (sesión 21, 2026-09-26): migraciones 20260926–20261006 aplicadas a `serenata-erp`, verificadas contra los archivos (md5 de cada función) y contra el snapshot de datos; PR #96 mergeado (`f01097d`) y desplegado |
