# Sueltos post-PR #76: Portal, utilidad de proyecto y `cliente_id` FK (archivado)

**Estado: Cerrado (2026-09-21), parcial por decisión del usuario.** Bloques
1-3 completos y mergeados. El Bloque 4 (filtro de estado en Cuentas) se
diferió sin cerrar diseño — el usuario pidió liberar el slot de
`docs/PLAN.md` (tracker de una sola iniciativa a la vez) para la nueva
iniciativa "Editor de PDFs". El Bloque 4 vive ahora como pendiente suelto en
`docs/ROADMAP.md` → "Después", junto al suelto de Dashboard, para retomarse
en una sesión futura sin volver a abrir este archivo.

---

**Estado original de la iniciativa (2026-09-19/20), sin editar debajo de
esta línea salvo el tracker de Bloque 4:** agrupación de los
...
Bloque 4 (filtro de estado) queda diferido — ver nota de cierre arriba.
...
| 4 | Cuentas: filtro de estado en vista principal | Diferido (2026-09-21) — movido a `docs/ROADMAP.md` → "Después" |
