/**
 * Rediseño de Cuentas B3 (docs/PLAN.md, O1, O1b, U1): forma cruda del año que
 * devuelve `cuentas_por_proyecto(p_year)` y su decodificación. Módulo puro,
 * sin acceso a la BD: lo comparten la ruta, los tests y los mocks e2e.
 *
