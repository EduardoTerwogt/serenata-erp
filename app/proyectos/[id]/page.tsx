  ...
  return (
    <div className="max-w-5xl">
      <div className="mb-6 flex flex-col gap-4">
        <Button href="/proyectos" variant="ghost" size="md" iconLeft="arrow-left" className="self-start">
          Proyectos
        </Button>
        ...
        <div className="flex flex-col items-start justify-between gap-4 md:flex-row">
          <div>
            <div className="flex flex-wrap items-center gap-3">
              <h1 className="sn-display text-h2 text-ink break-words">{proyecto.proyecto}</h1>
              {etapaActual ? (
            ...
            <p className="mt-1 break-words text-subtext">{proyecto.cliente}</p>
          </div>
          <div className="flex flex-col items-start gap-3 md:items-end">
            {pm.tipoAsignado && (
              <EtapaSelector etapas={pm.tipoAsignado.etapas} etapaActualId={proyecto.etapa_id} onCambiar={pm.cambiarEtapa} />
            )}
            <div className="grid w-full grid-cols-1 gap-2 sm:grid-cols-2 md:flex md:w-auto md:flex-row md:flex-wrap md:justify-end">
              <Button
                variant="secondary"
                size="md"
                iconLeft="printer"
