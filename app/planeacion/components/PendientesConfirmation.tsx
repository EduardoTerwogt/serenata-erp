    ...
    <div className="max-w-3xl mx-auto flex flex-col gap-6">
      ...
      {toCreate.length > 0 && (
        <div className="rounded-panel border border-hairline bg-card p-6">
          <h3 className="text-h3 font-semibold text-ink mb-4">Detalle de pendientes:</h3>
      ...
      <div className="rounded-control border border-hairline bg-row p-4">
        <p className="text-sm text-subtext">
          Las cotizaciones se crearán en estado <span className="font-medium text-body">BORRADOR</span> para que puedas revisarlas antes de enviarlas. Los pendientes procesados se eliminarán automáticamente.
        </p>
      </div>
